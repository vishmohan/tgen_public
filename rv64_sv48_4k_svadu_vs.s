...
.section .ptl3, "aw"
	.set ppn2, 0
	.rept 512
			make_leaf_pte_entry (ppn2<<30)>>12 0x0f 0 0
		.set ppn2, ppn2+1
	.endr
...
.section .vptl3, "aw"
		...
		.set idx, 1
		.rept 511
			make_leaf_pte_entry (idx<<30)>>12 0x0f 0 0
		  .set idx, idx+1
		.endr
...
.section .vptl1, "aw"
			.set idx, 0
			.rept 512
				make_leaf_pte_entry (idx<<12)>>12 0x0f 0 0
				.set idx, idx+1
			.endr
...
.section .vptl1_1, "aw"
			...
			.set idx, 0
			.rept 512
				make_leaf_pte_entry (ppn<<21|idx<<12)>>12 0x0f 0 0
				.set idx, idx+1
			.endr
...
.section .hptl1, "aw"
	.set ppn, 0
	.rept 512
		make_leaf_pte_entry (ppn<<12)>>12 0x1f 0 0
	.set ppn, ppn+1
	.endr
...
.section .hptl1_1, "aw"
	...
	.set idx, 0
	.rept 512
		make_leaf_pte_entry (ppn<<21|idx<<12)>>12 0x1f 0 0
		.set idx, idx+1
	.endr
