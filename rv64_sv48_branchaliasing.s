...
.equ t0_code, 0x200000
.equ t1_code, 0x1000a00000
.equ t2_code, 0x2001200000
.equ t3_code, 0x3001a00000
...
#{.code2:0x1000a00000:0xa00000}
.section .code2 , "aw"
code2_begin:

#{.code3:0x2001200000:0x1200000}
.section .code3 , "aw"
code3_begin:

#{.code4:0x3001a00000:0x1a00000}
.section .code4 , "aw"
code4_begin:

#{.code5:0x4002200000:0x2200000}
.section .code5 , "aw"
code5_begin:

#{.code6:0x5002a00000:0x2a00000}
.section .code6 , "aw"
code6_begin:

#{.code7:0x6003200000:0x3200000}
.section .code7 , "aw"
code7_begin:

#{.code8:0x7003a00000:0x3a00000}
.section .code8 , "aw"
code8_begin:


#no code9_begin donot want random instructions here
#{.code9:0x4040020f0:0x4040020f0}
.section .code9 , "aw"
	.rept 512
		ecall
	.endr
